...
var K = (t, o) => () => (o || t((o = { exports: {} }).exports, o), o.exports);
var Z = (t, o, g, u) => {
...
var J = (t, o, g) => (
  ...
  Z(
    o || !t || !t.__esModule
      ? j(g, "default", { value: t, enumerable: !0 })
      : g,
    t,
  )
);
        ...
        let o = "The message port closed before a response was received.",
          g = (u) => {
            ...
            let D = (e) =>
              ...
              N = (e, r) =>
                function (a, ...m) {
                  if (m.length < r.minArgs)
                    throw new Error(
                      `Expected at least ${r.minArgs} ${h(r.minArgs)} for ${e}(), got ${m.length}`,
                    );
                  if (m.length > r.maxArgs)
                    throw new Error(
                      `Expected at most ${r.maxArgs} ${h(r.maxArgs)} for ${e}(), got ${m.length}`,
                    );
                  return new Promise((l, c) => {
                    if (r.fallbackToNoCallback)
                      try {
                        a[e](...m, C({ resolve: l, reject: c }, r));
                      } catch (s) {
                        (console.warn(
                      ...
                      let f = (v) => {
                        v.then(
                          ...
                          (A) => {
                            let y;
                            (A &&
                            (A instanceof Error || typeof A.message == "string")
                              ? (y = A.message)
              ...
              $ = ({ reject: e, resolve: r }, n) => {
                u.runtime.lastError
                  ? u.runtime.lastError.message === o
                    ? r()
              ...
              I = (e, r, n, ...a) => {
                ...
                return new Promise((m, l) => {
                  let c = $.bind(null, { resolve: m, reject: l });
...
async function G(t, o) {
  await S.default.runtime.sendMessage({ msg: t, channel: o });
}
function L(t) {
  let o = p.FromInjectedToService;
  G(t, o);
}
function R(t) {
  let o = (g) => {
    g.channel == p.FromServiceToInjected && t(g.msg);
  };
  return (
    S.default.runtime.onMessage.addListener(o),
    () => {
      S.default.runtime.onMessage.removeListener(o);
    }
  );
}
function Q(t) {
  L({ name: "on_activate_addon", data: { key: t.detail.message } });
}
...
var X = R((t) => {
  (document.dispatchEvent(new CustomEvent(t.name, { detail: t.data })), X());
});
