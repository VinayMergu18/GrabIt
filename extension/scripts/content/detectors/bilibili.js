...
(function (e) {
  function r() {
    ...
    for (var g = [], p = 0, l = o; p < l.length; p++) {
      var t = l[p];
...
(function (e) {
  function r(p) {
    ...
    for (
      var a = p === void 0 ? [] : Array.isArray(p) ? p : L([p], l, !0),
        u = [],
        m = 0,
        d = a;
      m < d.length;
...
var j = function (e, r, n, s) {
  ...
  G = function (e, r) {
    var n = {
      ...
      g;
    return (
      (g = { next: p(0), throw: p(1), return: p(2) }),
...
function D(e) {
  ...
  if (Array.isArray(e))
    return { __serde_tag: "array", __serde_val: e.map((r) => D(r)) };
  ...
  if (e instanceof Headers) {
    ...
    if (e instanceof Set)
      return { __serde_tag: "set", __serde_val: [...e.values()].map(D) };
    if (e instanceof Map)
      return {
        __serde_tag: "map",
    ...
    if ($.isOption(e))
      return e.isSome()
        ? { __serde_tag: "some", __serde_val: D(e.value) }
        : { __serde_tag: "none" };
    if (H.isResult(e))
      return e.isOk()
        ? { __serde_tag: "ok", __serde_val: D(e.value) }
        : { __serde_tag: "err", __serde_val: D(e.error) };
    if (typeof e == "object") {
      let r = {};
...
function Ve(e, r) {
  let i = e.size.map((t) => t.height).unwrapOr(0),
    g = r.size.map((t) => t.height).unwrapOr(0),
    p = e.bitrate.unwrapOr(0),
    l = r.bitrate.unwrapOr(0);
  return i > g ? -1 : i < g ? 1 : p > l ? -1 : p < l ? 1 : 0;
}
function de(e) {
  return [...e.values()].sort((r, n) => Ve(r.quality, n.quality));
}
function ce(e) {
  function r(c, w) {
    return (c << w) | (c >>> (32 - w));
  ...
  for (let c = 0; c < f.length; c += 16) {
    let w = a,
      ...
      F = m,
      y = d;
    ((a = l(o, a, u, m, d, f[c + 0], 7, t[1])),
      (d = l(o, d, a, u, m, f[c + 1], 12, t[2])),
      (m = l(o, m, d, a, u, f[c + 2], 17, t[3])),
      (u = l(o, u, m, d, a, f[c + 3], 22, t[4])),
      (a = l(o, a, u, m, d, f[c + 4], 7, t[5])),
      (d = l(o, d, a, u, m, f[c + 5], 12, t[6])),
      (m = l(o, m, d, a, u, f[c + 6], 17, t[7])),
      (u = l(o, u, m, d, a, f[c + 7], 22, t[8])),
      (a = l(o, a, u, m, d, f[c + 8], 7, t[9])),
      (d = l(o, d, a, u, m, f[c + 9], 12, t[10])),
      (m = l(o, m, d, a, u, f[c + 10], 17, t[11])),
      (u = l(o, u, m, d, a, f[c + 11], 22, t[12])),
      (a = l(o, a, u, m, d, f[c + 12], 7, t[13])),
      (d = l(o, d, a, u, m, f[c + 13], 12, t[14])),
      (m = l(o, m, d, a, u, f[c + 14], 17, t[15])),
      (u = l(o, u, m, d, a, f[c + 15], 22, t[16])),
      (a = l(i, a, u, m, d, f[c + 1], 5, t[17])),
      (d = l(i, d, a, u, m, f[c + 6], 9, t[18])),
      (m = l(i, m, d, a, u, f[c + 11], 14, t[19])),
      (u = l(i, u, m, d, a, f[c + 0], 20, t[20])),
      (a = l(i, a, u, m, d, f[c + 5], 5, t[21])),
      (d = l(i, d, a, u, m, f[c + 10], 9, t[22])),
      (m = l(i, m, d, a, u, f[c + 15], 14, t[23])),
      (u = l(i, u, m, d, a, f[c + 4], 20, t[24])),
      (a = l(i, a, u, m, d, f[c + 9], 5, t[25])),
      (d = l(i, d, a, u, m, f[c + 14], 9, t[26])),
      (m = l(i, m, d, a, u, f[c + 3], 14, t[27])),
      (u = l(i, u, m, d, a, f[c + 8], 20, t[28])),
      (a = l(i, a, u, m, d, f[c + 13], 5, t[29])),
      (d = l(i, d, a, u, m, f[c + 2], 9, t[30])),
      (m = l(i, m, d, a, u, f[c + 7], 14, t[31])),
      (u = l(i, u, m, d, a, f[c + 12], 20, t[32])),
      (a = l(g, a, u, m, d, f[c + 5], 4, t[33])),
      (d = l(g, d, a, u, m, f[c + 8], 11, t[34])),
      (m = l(g, m, d, a, u, f[c + 11], 16, t[35])),
      (u = l(g, u, m, d, a, f[c + 14], 23, t[36])),
      (a = l(g, a, u, m, d, f[c + 1], 4, t[37])),
      (d = l(g, d, a, u, m, f[c + 4], 11, t[38])),
      (m = l(g, m, d, a, u, f[c + 7], 16, t[39])),
      (u = l(g, u, m, d, a, f[c + 10], 23, t[40])),
      (a = l(g, a, u, m, d, f[c + 13], 4, t[41])),
      (d = l(g, d, a, u, m, f[c + 0], 11, t[42])),
      (m = l(g, m, d, a, u, f[c + 3], 16, t[43])),
      (u = l(g, u, m, d, a, f[c + 6], 23, t[44])),
      (a = l(g, a, u, m, d, f[c + 9], 4, t[45])),
      (d = l(g, d, a, u, m, f[c + 12], 11, t[46])),
      (m = l(g, m, d, a, u, f[c + 15], 16, t[47])),
      (u = l(g, u, m, d, a, f[c + 2], 23, t[48])),
      (a = l(p, a, u, m, d, f[c + 0], 6, t[49])),
      (d = l(p, d, a, u, m, f[c + 7], 10, t[50])),
      (m = l(p, m, d, a, u, f[c + 14], 15, t[51])),
      (u = l(p, u, m, d, a, f[c + 5], 21, t[52])),
      (a = l(p, a, u, m, d, f[c + 12], 6, t[53])),
      (d = l(p, d, a, u, m, f[c + 3], 10, t[54])),
      (m = l(p, m, d, a, u, f[c + 10], 15, t[55])),
      (u = l(p, u, m, d, a, f[c + 1], 21, t[56])),
      (a = l(p, a, u, m, d, f[c + 8], 6, t[57])),
      (d = l(p, d, a, u, m, f[c + 15], 10, t[58])),
      (m = l(p, m, d, a, u, f[c + 6], 15, t[59])),
      (u = l(p, u, m, d, a, f[c + 13], 21, t[60])),
      (a = l(p, a, u, m, d, f[c + 4], 6, t[61])),
      (d = l(p, d, a, u, m, f[c + 11], 10, t[62])),
      (m = l(p, m, d, a, u, f[c + 2], 15, t[63])),
      (u = l(p, u, m, d, a, f[c + 9], 21, t[64])),
      (a = s(a, w)),
      (u = s(u, T)),
      (m = s(m, F)),
      (d = s(d, y)));
...
function Ue(e) {
  const media = D(e);
  ae({ name: "on_media", data: { media: media } });
  // Send STREAM_DETECTED message for GrabIt's stream tab
  try {
    let url = null;
    if (media && typeof media === 'object') {
      url = media.url || media.uri || media.src;
    ...
    console.error('Failed to send STREAM_DETECTED message:', err);
  }
}
function Ne(e, r) {
...
async function We() {
  ...
  if (e.ep_id)
    try {
      let r = await fetch(
        `https://api.bilibili.tv/intl/gateway/web/playurl?s_locale=en_US&platform=web&ep_id=${e.ep_id}&qn=64&type=0&device=wap&tf=0&spm_id=bstar-web.pgc-video-detail.0.0&from_spm_id=bstar-web.homepage.recommend.all`,
      );
    ...
    try {
      let r = await fetch(
        `https://api.bilibili.tv/intl/gateway/web/playurl?s_locale=en_US&platform=web&aid=${e.ai_id}&qn=64&type=0&device=wap&tf=0&spm_id=bstar-web.ugc-video-detail.0.0&from_spm_id=bstar-web.homepage.recommend.all`,
      );
      return I(JSON.parse(await r.text()));
    } catch (r) {
      return M(`Error fetching /web/playurl for episode id ${e} : ${r}`);
...
async function fe() {
  ...
  if (g.isErr()) {
    console.error(
      `Invalid bilibili tv data, playlist failed to build ${g.error}`,
    );
    return;
  }
