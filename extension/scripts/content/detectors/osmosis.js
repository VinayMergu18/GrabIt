  ...
  if ((r && typeof r == "object") || typeof r == "function")
    for (let n of Oe(r))
      !Pe.call(i, n) &&
        ...
        de(i, n, {
          get: () => r[n],
          enumerable: !(e = De(r, n)) || e.enumerable,
        });
  return i;
};
var ge = (i, r, t) => (
        ...
        let r = "The message port closed before a response was received.",
          t = (e) => {
            ...
            class a extends WeakMap {
              constructor(f, c = void 0) {
                (super(c), (this.createItem = f));
              }
              get(f) {
                return (
            ...
            let o = (m) =>
              ...
              l =
                ...
                (...c) => {
                  e.runtime.lastError
                    ...
                    : f.singleCallbackArg ||
                        (c.length <= 1 && f.singleCallbackArg !== !1)
                      ? m.resolve(c[0])
                      : m.resolve(c);
                },
              g = (m) => (m == 1 ? "argument" : "arguments"),
              u = (m, f) =>
                function (A, ...v) {
                  if (v.length < f.minArgs)
                    throw new Error(
                      `Expected at least ${f.minArgs} ${g(f.minArgs)} for ${m}(), got ${v.length}`,
                    );
                  if (v.length > f.maxArgs)
                    throw new Error(
                      `Expected at most ${f.maxArgs} ${g(f.maxArgs)} for ${m}(), got ${v.length}`,
                    );
                  return new Promise((M, P) => {
                    if (f.fallbackToNoCallback)
                      try {
                        A[m](...v, l({ resolve: M, reject: P }, f));
                      } catch (y) {
                        (console.warn(
              ...
              w = (m, f = {}, c = {}) => {
                let A = Object.create(null),
                  v = {
                    ...
                    get(P, y, N) {
                      ...
                      if (typeof E == "function")
                        if (typeof f[y] == "function") E = h(m, m[y], f[y]);
                        else if (_(c, y)) {
                          let L = u(y, c[y]);
                          E = h(m, m[y], L);
                        } else E = E.bind(m);
                  ...
                  M = Object.create(m);
                return new Proxy(M, v);
              },
              R = (m) => ({
                addListener(f, c, ...A) {
                  f.addListener(m.get(c), ...A);
                },
                hasListener(f, c) {
                  return f.hasListener(m.get(c));
                },
                removeListener(f, c) {
                  f.removeListener(m.get(c));
                },
              }),
              x = new a((m) =>
                typeof m != "function"
              ...
              $ = ({ reject: m, resolve: f }, c) => {
                e.runtime.lastError
                  ? e.runtime.lastError.message === r
                    ? f()
                    : m(new Error(e.runtime.lastError.message))
                  : c && c.__mozWebExtensionPolyfillReject__
                    ? m(new Error(c.message))
                    : f(c);
              },
              O = (m, f, c, ...A) => {
                if (A.length < f.minArgs)
                  throw new Error(
                    `Expected at least ${f.minArgs} ${g(f.minArgs)} for ${m}(), got ${A.length}`,
                  );
                if (A.length > f.maxArgs)
                  throw new Error(
                    `Expected at most ${f.maxArgs} ${g(f.maxArgs)} for ${m}(), got ${A.length}`,
                  );
                return new Promise((v, M) => {
                  let P = $.bind(null, { resolve: v, reject: M });
                  (A.push(P), c.sendMessage(...A));
                });
              },
              p = {
                devtools: { network: { onRequestFinished: R(x) } },
                runtime: {
                  onMessage: R(s),
                  onMessageExternal: R(s),
...
(function (i) {
  function r() {
    ...
    for (var o = [], l = 0, g = n; l < g.length; l++) {
      var u = g[l];
  ...
  i.any = t;
  function e(n) {
    return n instanceof S || n === b;
  }
  i.isOption = e;
})(q || (q = {}));
var V = function (i, r, t) {
...
(function (i) {
  function r(l) {
    ...
    for (
      var h = l === void 0 ? [] : Array.isArray(l) ? l : V([l], g, !0),
        _ = [],
        w = 0,
        R = h;
      w < R.length;
  ...
  function n(l) {
    try {
      ...
      return Promise.resolve(new T(g));
    }
  }
  i.wrapAsync = n;
  function a(l) {
  ...
  i.partition = a;
  function o(l) {
    return l instanceof T || l instanceof D;
  }
  i.isResult = o;
})(W || (W = {}));
var Y = function (i, r, t, e) {
    ...
    return new (t || (t = Promise))(function (a, o) {
      ...
      function u(h) {
        h.done ? a(h.value) : n(h.value).then(l, g);
      }
        ...
        return this.thenInternal(function (e) {
          return Y(t, void 0, void 0, function () {
            ...
            return K(this, function (a) {
              switch (a.label) {
                case 0:
                  return e.isErr() ? [2, e] : ((n = D), [4, r(e.value)]);
                case 1:
        ...
        return this.thenInternal(function (e) {
          return Y(t, void 0, void 0, function () {
            ...
            return K(this, function (a) {
              switch (a.label) {
                case 0:
                  return e.isOk() ? [2, e] : ((n = T), [4, r(e.error)]);
                case 1:
                  return [2, n.apply(void 0, [a.sent()])];
              }
            });
        ...
        return this.thenInternal(function (e) {
          return ee(t, void 0, void 0, function () {
            ...
            return te(this, function (a) {
              switch (a.label) {
                case 0:
                  return e.isNone() ? [2, e] : ((n = S), [4, r(e.value)]);
                case 1:
                  return [2, n.apply(void 0, [a.sent()])];
              }
            });
  ...
  return r.status >= 400 && r.status <= 599
    ...
    : r.ok
      ? r.body != null
        ? D(r)
        : T(j("No body"))
      : T(j(`Unkown failure - status ${r.status}`));
}
var _e = ge(Ae(), 1);
var Pt = new BroadcastChannel("worker_service");
var ie = {
...
function be(i) {
  let r = ie.FromInjectedToService;
  Xe(i, r);
}
function k(i) {
      ...
      this.tagMappers
        ...
        .forEach((a) => {
          ...
          if (((t = /^#EXT-X-BYTERANGE:(.*)?$/.exec(a)), t)) {
            ((e = X(oe(t[1]), { type: "tag", tagType: "byterange" })),
              this.trigger("data", e));
            return;
          }
  ...
  ue = function (i) {
    ...
    (t &&
      ...
      e &&
        r[o] < g &&
        (this.trigger("warn", {
          message: `${n} clamping PART-HOLD-BACK (${r[o]}) to partTargetDuration * 2 (${g}).`,
        }),
        (r[o] = g)));
  },
  J = class extends Q {
                ...
                ({
                  ...
                  media() {
                    ...
                    ((p[s.attributes["GROUP-ID"]] =
                      p[s.attributes["GROUP-ID"]] || {}),
                      ($ = p[s.attributes["GROUP-ID"]]),
                      (O = { default: /yes/i.test(s.attributes.DEFAULT) }),
                      O.default
                        ? (O.autoselect = !0)
                        : (O.autoselect = /yes/i.test(s.attributes.AUTOSELECT)),
                      s.attributes.LANGUAGE &&
                        (O.language = s.attributes.LANGUAGE),
                      s.attributes.URI && (O.uri = s.attributes.URI),
                      s.attributes["INSTREAM-ID"] &&
                        (O.instreamId = s.attributes["INSTREAM-ID"]),
                      s.attributes.CHARACTERISTICS &&
                        (O.characteristics = s.attributes.CHARACTERISTICS),
                      s.attributes.FORCED &&
                        (O.forced = /yes/i.test(s.attributes.FORCED)),
                      ($[s.attributes.NAME] = O));
                  },
                  discontinuity() {
                    ((_ += 1),
                  ...
                  part() {
                    ...
                    ((n.parts = n.parts || []),
                      ...
                      d.byterange &&
                        (d.byterange.hasOwnProperty("offset") ||
                          (d.byterange.offset = R),
                        (R = d.byterange.offset + d.byterange.length)));
                    ...
                    (this.warnOnMissingAttributes_(
                      ...
                      this.manifest.renditionReports &&
                        this.manifest.renditionReports.forEach((f, c) => {
                  ...
                  "preload-hint"() {
                    ...
                    ((n.preloadHints = n.preloadHints || []),
                      ...
                      d.byterange &&
                        (d.byterange.hasOwnProperty("offset") ||
                          ((d.byterange.offset = m ? R : 0),
                          m && (R = d.byterange.offset + d.byterange.length))));
                    ...
                    if (
                      ...
                      for (let c = 0; c < n.preloadHints.length - 1; c++) {
                        let A = n.preloadHints[c];
                        A.type &&
                          A.type === d.type &&
                          this.trigger("warn", {
                            message: `#EXT-X-PRELOAD-HINT #${f} for segment #${p} has the same TYPE ${d.type} as preload hint #${c}`,
                          });
                      }
                  },
                  "rendition-report"() {
                  ...
                  daterange() {
                    ...
                    if (
                      ...
                      let c = d.startDate.getTime() + d.duration * 1e3;
                      this.manifest.dateRanges[p].endDate = new Date(c);
                    }
                    if (!x[d.id]) x[d.id] = d;
                    else {
                      for (let c in x[d.id])
                        if (
                          d[c] &&
                          JSON.stringify(x[d.id][c]) !== JSON.stringify(d[c])
                        ) {
                          this.trigger("warn", {
                            message:
...
async function Ze() {
  let i = Je();
  if (i.isNone()) return b;
  let r = await he(`https://www.osmosis.org/videoPlaylist?hash=${i.value}`);
  if (r.isErr()) return b;
  let e = [...(await r.value.text())].reverse().join("");
  e = e.replace(
    /(#EXT-X-KEY:[^\n]*URI=")([^"]+)"/,
    (l, g, u) => g + new URL(u, "https://www.osmosis.org").href + '"',
  );
  let n = Se(e);
  if (n.isErr()) return b;
  let a = we(n.value),
    o = {
      ...
      thumbnail_url: b,
      demuxer: "mp4",
      url: new URL(`data:text/plain;charset=UTF-8,${encodeURIComponent(e)}`),
      cache: "default",
    };
  return S(o);
}
