        ...
        return this.thenInternal(function (e) {
          return ae(t, void 0, void 0, function () {
            ...
            return se(this, function (a) {
              switch (a.label) {
                case 0:
                  return e.isNone() ? [2, e] : ((n = v), [4, r(e.value)]);
                case 1:
                  return [2, n.apply(void 0, [a.sent()])];
              }
            });
...
function be(i) {
  for (let r of Je) if (r.mime_reg.test(i)) return v(r.demuxer);
  return _;
}
function et(i, r) {
      ...
      this.tagMappers
        ...
        .forEach((a) => {
          ...
          if (((t = /^#EXT-X-BYTERANGE:(.*)?$/.exec(a)), t)) {
            ((e = B(de(t[1]), { type: "tag", tagType: "byterange" })),
              this.trigger("data", e));
            return;
          }
...
function Ie(i, r, t) {
  ...
  let n;
  for (let a of r) if (((n = e.get(a)), n)) return v(n);
  for (let a of r) {
    let u = a.split("-")[0];
    if (!u) continue;
    let l = e.get(u);
    if (l) return v(l);
    for (let [d, o] of e) if (d.split("-")[0] === u) return v(o);
  }
  return _;
}
var Sr = (() => {
...
function Oe(i, r, t, e = !1, n = !1) {
  ...
  for (let o of u) {
    ...
    if (o.attributes.AUDIO) {
      ...
      if (E) {
        if (t.isSome()) {
          ...
          if (g.isSome()) T = D(g.value.uri, r.href);
          else {
            let m = Object.values(E).find((c) => c.default);
            T = m ? D(m.uri, r.href) : _;
          }
        } else
          for (let g of Object.values(E))
            if ((g.uri && (T = D(g.uri, r.href)), g.default)) break;
      }
    }
    let w = _,
      S = _;
    (o.attributes.RESOLUTION &&
      ...
      o.attributes.BANDWIDTH && (S = v(o.attributes.BANDWIDTH)));
  ...
  return ((d = Te(d)), ve(d) ? O(d) : x("Empty playlist"));
}
async function De(i) {
...
async function ht() {
  ...
  if (e && n) {
    ...
    (y && (a = D(y.url)),
      o.value.data.record.title && (u = v(o.value.data.record.title)),
    ...
    (y && (a = D(y.url)),
      o.value.data.stream.title && (u = v(o.value.data.stream.title)),
